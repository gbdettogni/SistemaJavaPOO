...
public class RelatorioGeral {
    public static void criaRelatorios(String caminho) throws IOException {
        File planejamentoFile = new File("saida/1-planejamento.csv");
        planejamentoFile.createNewFile();
        File estPrestadoresFile = new File("saida/2-estatisticas-prestadores.csv");
        estPrestadoresFile.createNewFile();
        File estCasaisFile = new File("saida/3-estatisticas-casais.csv");
